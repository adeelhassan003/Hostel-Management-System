...
<div id="content" class="content">
    ...
    <ol class="breadcrumb pull-right">
        ...
        <li class="breadcrumb-item active">Single Month Rent</li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">
        Showing rents of <?php echo $month . ', ' .  $year; ?>
    </h1>
    <!-- end page-header -->
                    ...
                    <table id="data-table-buttons" class="table table-striped table-bordered">
                        ...
                        <?php
                            ...
                            if ($this->session->userdata('user_type') == 3) {
                                ...
                                $bill_info = $this->db->get_where('tenant_rent', array('month' => $month, 'year' => $year, 'tenant_id' => $tenant_id))->result_array();
                            } else {
        ...
        <div class="col-lg-3">
            ...
            <div class="widget widget-stats bg-orange">
                ...
                <div class="stats-info">
                    <h4><b>Due Rents of <?php echo $month . ', ' . $year; ?></b></h4>
                    <p>
                        <?php echo $this->db->get_where('setting', array('name' => 'currency'))->row()->content; ?>
                        <?php
            ...
            <div class="widget widget-stats bg-blue">
                ...
                <div class="stats-info">
                    <h4><b>Rents of <?php echo $month . ', ' . date('Y'); ?></b></h4>
                    <p>
                        <?php echo $this->db->get_where('setting', array('name' => 'currency'))->row()->content; ?>
                        <?php
                            $this->db->select_sum('amount');
