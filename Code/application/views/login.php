...
<body  style="background-color:#1e6fa8">
	<!-- begin #page-loader -->
	...
	<div id="page-container" class="fade" >
		...
		<div class="login login-with-news-feed" >
			<!-- begin news-feed -->
			<div class="news-feed">
				<div class="news-image" style="background-image: url(<?php echo base_url(); ?>uploads/website/login-bg.jpg)"></div>
			</div>
			<!-- end news-feed -->
			<!-- begin right-content -->
			<div class="right-content">
				...
				<div class="login-header">
					<div class="brand" style="color:white">
						...
						<small style="color:white"><?php echo html_escape($this->db->get_where('setting', array('name' => 'tagline'))->row()->content); ?></small>
					</div>
					<div class="icon">
  ...
  <p class="text-center" style="color:white">Copyright © <a href="https://www.zamzamhostel.com/"     	target="_blank">Zam Zam Hostel</a> 2019 - All rights reserved. <br>Designed by 	<a href="https://www.softoj.com/"     	target="_blank">SOFTOJ</a> 	 </p>
