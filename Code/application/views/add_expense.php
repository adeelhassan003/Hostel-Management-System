                ...
                <div class="panel-body">
					<?php echo form_open('expenses/add', array('method' => 'post', 'data-parsley-validate' => 'true')); ?>
                        <div class="form-group">
                            ...
                            <input autofocus type="text" name="name" placeholder="Enter name of the expense" class="form-control" data-parsley-required="true" data-parsley-pattern="/^[\w\-\s]+$/">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea style="resize: none" type="text" name="description" placeholder="Enter description of the expense" class="form-control"  data-parsley-pattern="/^[\w\-\s\.]+$/"></textarea>
                        </div>
