                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                        ...
                                        $total = $overall_amount;
                                        echo $total > 0 ? $this->db->get_where('setting', array('name' => 'currency'))->row()->content . ' ' . $total : '-';
                                    ?>
                                </td>
                                <td>
                                    <?php
                                        ...
                                        $paid  = $paid_advance;
                                        echo $overall_advance > 0 ? $this->db->get_where('setting', array('name' => 'currency'))->row()->content . ' ' . $overall_advance : '-';
                                    ?>
                                </td>
                                <td>
                                  
									<?php echo ($overall_amount - $overall_advance) > 0 ? $this->db->get_where('setting', array('name' => 'currency'))->row()->content . ' ' . ($overall_amount - $overall_advance) : '-'; ?>
                                </td>
                                <td>
                                    <?php
                                        $this->db->select_sum('amount');
                                ...
                                <td>
                                    <?php echo ($overall_advance) ? $this->db->get_where('setting', array('name' => 'currency'))->row()->content . ' ' . ($overall_advance) : '-'; ?>
                                </td>
                                <td>
                                    <?php echo ($overall_advance - $staff_salary - $utility_bills - $expenses) ? $this->db->get_where('setting', array('name' => 'currency'))->row()->content . ' ' . ($overall_advance - $staff_salary - $utility_bills - $expenses) : '-'; ?>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                        </tbody>
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <select class="form-control selectpicker" data-size="10" data-live-search="true" data-parsley-required="true" name="year">
                                ...
                                <option <?php if ($year  == (date('Y') + 5)) echo 'selected'; ?> value="<?php echo date('Y') + 5; ?>"><?php echo date('Y') + 5; ?></option>
                            </select>
                        </div>
                    </div>
