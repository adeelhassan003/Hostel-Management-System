<?php echo form_open('profession_settings/update/' . $param2, array('id' => 'edit_profession', 'method' => 'post', 'data-parsley-validate' => 'true')); ?>
	<div class="form-group">
		...
		<input value="<?php echo html_escape($this->db->get_where('profession', array('profession_id' => $param2))->row()->name); ?>" type="text" name="name" placeholder="Enter profession name" class="form-control" data-parsley-required="true" data-parsley-pattern="/^[\w\-\s]+$/">
	</div>
