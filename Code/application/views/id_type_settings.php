                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <a class="dropdown-item" href="javascript:;" onclick="confirm_modal('<?php echo base_url(); ?>id_type_settings/remove/<?php echo $row['id_type_id']; ?>');" >
                                                Remove
                                            </a>
                                        </div>
                                    </div>
                ...
                <div class="panel-body">
					<?php echo form_open('id_type_settings/add', array('method' => 'post', 'data-parsley-validate' => 'true')); ?>
						<div class="form-group">
							...
							<input type="text" name="name" placeholder="Enter ID type name" class="form-control" data-parsley-required="true" data-parsley-pattern="/^[\w\-\s]+$/">
						</div>
