                ...
                <div class="panel-body">
                    ...
                    foreach ($user_info as $row):
                        ...
                        <div class="form-group">
                            ...
                            <input <?php if ($this->db->get_where('user', array('user_id' => $this->session->userdata('user_id')))->row()->user_type == 2) echo 'readonly'; ?> value="<?php echo html_escape($row['email']); ?>" type="email" name="email"
                            placeholder="Enter email" class="form-control" data-parsley-required="true">
                        </div>
                        <div class="form-group">
                            <label>Current Password</label><b><span style="color:red"> *</span></b>
                        ...
                        <div class="form-group">
                            <label>New Password</label><b><span style="color:red"> *</span></b>
