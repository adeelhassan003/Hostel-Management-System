<?php echo form_open('id_type_settings/update/' . $param2, array('id' => 'edit_id_type', 'method' => 'post', 'data-parsley-validate' => 'true')); ?>
	<div class="form-group">
		...
		<input value="<?php echo html_escape($this->db->get_where('id_type', array('id_type_id' => $param2))->row()->name); ?>" type="text" name="name" placeholder="Enter profession name" class="form-control" data-parsley-required="true" data-parsley-pattern="/^[\w\-\s]+$/">
	</div>
